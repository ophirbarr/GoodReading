...
public class CostumerDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public CostumerDetachedCriteria() {
		super(good_reading.Costumer.class, good_reading.CostumerCriteria.class);
	...
	public CostumerDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, good_reading.CostumerCriteria.class);
		_uid = new IntegerExpression("_uid", this.getDetachedCriteria());
		_firstName = new StringExpression("_firstName", this.getDetachedCriteria());
		_lastName = new StringExpression("_lastName", this.getDetachedCriteria());
		_userName = new StringExpression("_userName", this.getDetachedCriteria());
	...
	public Costumer uniqueCostumer(PersistentSession session) {
		return (Costumer) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public Costumer[] listCostumer(PersistentSession session) {
