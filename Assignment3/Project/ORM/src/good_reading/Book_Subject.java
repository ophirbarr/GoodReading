...
public class Book_Subject implements Serializable {
	...
	public static Book_Subject loadBook_SubjectByORMID(int _bid) throws PersistentException {
		try {
			PersistentSession session = good_reading.GoodReadingPersistentManager.instance().getSession();
			return loadBook_SubjectByORMID(session, _bid);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Book_Subject getBook_SubjectByORMID(int _bid) throws PersistentException {
		try {
			PersistentSession session = good_reading.GoodReadingPersistentManager.instance().getSession();
			return getBook_SubjectByORMID(session, _bid);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Book_Subject loadBook_SubjectByORMID(int _bid, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = good_reading.GoodReadingPersistentManager.instance().getSession();
			return loadBook_SubjectByORMID(session, _bid, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Book_Subject getBook_SubjectByORMID(int _bid, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = good_reading.GoodReadingPersistentManager.instance().getSession();
			return getBook_SubjectByORMID(session, _bid, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Book_Subject loadBook_SubjectByORMID(PersistentSession session, int _bid) throws PersistentException {
		try {
			return (Book_Subject) session.load(good_reading.Book_Subject.class, new Integer(_bid));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Book_Subject getBook_SubjectByORMID(PersistentSession session, int _bid) throws PersistentException {
		try {
			return (Book_Subject) session.get(good_reading.Book_Subject.class, new Integer(_bid));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Book_Subject loadBook_SubjectByORMID(PersistentSession session, int _bid, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Book_Subject) session.load(good_reading.Book_Subject.class, new Integer(_bid), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Book_Subject getBook_SubjectByORMID(PersistentSession session, int _bid, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Book_Subject) session.get(good_reading.Book_Subject.class, new Integer(_bid), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
